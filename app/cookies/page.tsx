              ...
              <div className="space-y-6">
                <div className="p-6 border border-gray-200 rounded-xl">
                  <div className="flex items-center justify-between mb-2">
                    ...
                    <span className="text-xs font-mono px-2 py-1 bg-gray-50 rounded">Always active</span>
                  </div>
                  ...
                  <div className="mt-3 flex flex-wrap gap-2">
                    <span className="text-xs font-mono px-2 py-1 border border-gray-200 rounded">session_id</span>
                    <span className="text-xs font-mono px-2 py-1 border border-gray-200 rounded">csrf_token</span>
                    <span className="text-xs font-mono px-2 py-1 border border-gray-200 rounded">cookie-consent</span>
                  </div>
                </div>
                ...
                <div className="p-6 border border-gray-200 rounded-xl">
                  <div className="flex items-center justify-between mb-2">
                    ...
                    <span className="text-xs font-mono px-2 py-1 bg-gray-50 rounded">Optional</span>
                  </div>
                  <p className="text-sm text-gray-500 leading-relaxed">
                  ...
                  <div className="mt-3 flex flex-wrap gap-2">
                    <span className="text-xs font-mono px-2 py-1 border border-gray-200 rounded">_ga</span>
                    <span className="text-xs font-mono px-2 py-1 border border-gray-200 rounded">_ga_*</span>
                    <span className="text-xs font-mono px-2 py-1 border border-gray-200 rounded">_vercel_insights</span>
                  </div>
                </div>
                ...
                <div className="p-6 border border-gray-200 rounded-xl">
                  ...
                  <div className="mt-3 flex flex-wrap gap-2">
                    <span className="text-xs font-mono px-2 py-1 border border-gray-200 rounded">_fbp</span>
                    <span className="text-xs font-mono px-2 py-1 border border-gray-200 rounded">_gcl_au</span>
                    <span className="text-xs font-mono px-2 py-1 border border-gray-200 rounded">li_sugr</span>
                  </div>
                </div>
              </div>
            </section>
            ...
            <section>
              ...
              <ul className="space-y-2 text-gray-500">
                <li className="flex items-start gap-2">
                  ...
                  <span><strong className="text-gray-900">Cookie Banner:</strong> Use the cookie consent banner that appears when you first visit our site to set your preferences.</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="w-1.5 h-1.5 rounded-full bg-gray-900/30 mt-2 shrink-0" />
                  <span><strong className="text-gray-900">Browser Settings:</strong> Most browsers allow you to block or delete cookies through their settings menu.</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="w-1.5 h-1.5 rounded-full bg-gray-900/30 mt-2 shrink-0" />
                  <span><strong className="text-gray-900">Opt-Out Links:</strong> For third-party analytics, you can use tools like Google Analytics Opt-out Browser Add-on.</span>
                </li>
              </ul>
