...
function AnimatedCounter({ end, suffix = "", prefix = "" }: { end: number; suffix?: string; prefix?: string }) {
  ...
  return (
    <div ref={ref} className="text-4xl md:text-6xl lg:text-8xl font-display tracking-tight">
...
const metrics = [
  { 
    ...
    suffix: "+", 
    prefix: "",
    label: "Calls launched per minute",
  },
  { 
    value: 73, 
    suffix: "%", 
    prefix: "",
    label: "Cost reduction on hiring sales reps",
  },
  { 
    value: 30, 
    suffix: "+", 
  ...
  { 
    ...
    suffix: "+", 
    prefix: "",
    label: "Businesses trust VoiceLabs",
  },
];
