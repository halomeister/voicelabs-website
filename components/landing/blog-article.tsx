    ...
    <section className="max-w-[1400px] mx-auto px-6 lg:px-12 pb-24">
      ...
      <div className="max-w-3xl mb-12">
        <div className="flex items-center gap-3 mb-6">
          <span className="text-xs font-mono text-muted-foreground uppercase tracking-wider px-3 py-1 bg-secondary rounded-full">
            {post.category}
          </span>
        </div>
        ...
        {/* Meta */}
        <div className="flex flex-wrap items-center gap-6 pb-8 border-b border-foreground/10">
              ...
              >
                <div className="border border-foreground/10 rounded-2xl overflow-hidden">
                  <div className="aspect-[16/10] bg-accent flex items-center justify-center">
                    <div className="text-2xl font-display text-muted-foreground/20 p-6 text-center leading-tight">
                  ...
                  <div className="p-5">
                    ...
                    <h3 className="text-base font-display mt-2 group-hover:text-muted-foreground transition-colors duration-300 leading-snug">
                      {related.title}
                    </h3>
