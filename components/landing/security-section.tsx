...
const securityFeatures = [
  {
    ...
    description: "Customize speaking rate, speed, and patience level for natural conversations.",
  },
  {
    icon: Lock,
    title: "Sentiment Analysis",
    description: "Enhance customer experience with advanced sentiment analysis and voice management.",
  },
  {
    icon: Eye,
    title: "Smart Diarization",
    description: "Handle interruptions gracefully and detect conversation endings automatically.",
  },
  {
    icon: FileCheck,
    title: "Real-time Bookings",
    description: "Determine availability and schedule appointments instantly during calls.",
  },
];

const certifications = ["Autopilot Calls", "30+ Languages", "Smart Routing", "RAG Knowledge", "Flow Builder"];
